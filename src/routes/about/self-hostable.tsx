      ...
      <div class="row">
        ...
        <div class="article">
          ...
          <p>
            ...
            products offered by various companies with their own pros and cons,
            and this project comes with its own drawbacks.
          </p>
          <p>
            While some companies out there create password managers that rely on
            good hardware, they sometimes use weak software. Good companies will
            use both, good hardware and good software. There are many good
            companies in this sphere that offer extremely good products.
            CipherCrypt is a proof of concept, even though I plan on improving
            and innovating the project.
          </p>
          <p>
            But, the biggest weakness is in how it is implemented. For instance,
            many ecryption products rely on expensive hardware. But CipherCrypt
            is self-hosted, and you can implement it with any hardware you want,
            or use an online instance of MongoDB.
          </p>
        </div>
      </div>
    </div>
