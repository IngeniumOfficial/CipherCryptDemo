    ...
    <div id="inner-main">
      <div id="sidebar-section">
        ...
        <div id="sidebar-tabs">
          ...
          <A href="/about/caching" ref={cache} class="toggle pseudo button">
            Built-in Caching
          </A>
      ...
      <div id="article-tabs" class="tabs two">
        ...
        <div class="row">
          <div class="article">
            <h2>Caching</h2>
            <p>
              Caching in CipherCrypt is handled by a Caching Server Instance
              that runs Redis. Recently, there has been some controversy
              concerning Redis in the Open Source community. Although currently,
              during development, CipherCrypt is using an older version of
              Redis, there are plenty of drop-in replacements for Redis that are
              available. Before the project launches, an alternative will be
              chosen for use.
            </p>
            <p>
            ...
            <p>
              ...
              This allows the program to rely more on storing data temporarily
              in cache. While this speeds up the data transfer, this can
          ...
          <div class="article">
            ...
            <p>
              ...
              things, but is typically stored in memory (RAM). Access to data
              that is held in memory is pretty much instant.
            </p>
            ...
            <p>
              ...
              the cache is erased. However, CipherCrypt uses Redis as its
              caching server instance. Redis has a failsafe mechanism that takes
              "screenshots" of the data, which it stores on disk, so if anything
              goes wrong, the data can be recovered. While that is a neat
              feature, CipherCrypt still doesn't use Redis to replace the
              database. The application needs a database that works well with
              large amounts of data, and working with Redis with these demands
              becomes a challenge. So, Redis is used as caching.
            </p>
            <h4>
              If this is a bit difficult to understand, it might be a good idea
              to read the{" "}
              <A href="/about/technologies" class="inline-link">
                Core Technologies
              </A>{" "}
            ...
            <p>
              ...
              There is also an option that users can enable that allows more
              data to be stored in the cache at the cost of a heavier workload
              on the server.
            </p>
          </div>
        </div>
