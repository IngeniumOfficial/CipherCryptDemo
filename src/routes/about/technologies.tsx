        ...
        <main>
            ...
            <div id="inner-main">
                ...
                <Show when={explanation()} fallback={<div class="article">
                    ...
                    <p>
                      CipherCrypt uses two separate servers to organize its work efficiently.
                      Initially, the plan was for one server to handle everything: showing the website and performing complicated security tasks like encrypting and decrypting data.
                      The website is built using a tool called Next.js, while a language called Go handles the security tasks.
                      However, pluggin in a website made by Next.js into a Go server didn't work too well. Alternative solutions also relied on JavaScript, which didn't fit the project's needs.
                      To simplify things, the work is split between two separate servers:
                    </p>
                    <ol>
                      <li>The Web Server (Next.js/Node.js) focuses on displaying the website.</li>
                      <li>The API Server (Go/Gin-Gonic) handles the complicated security tasks.</li>
                    </ol>
                    <p>
                      This setup allows each server to do its job efficiently. Additionally the Web Server (Node.js) is given many other less-intense tasks to perform (logging, some authorization, reading cache, etc.).
                    </p>
                    <h3>API Server</h3>
                    <p>
                    CipherCrypt's API server, powered by Go, takes care of the complex tasks. It securely handles:
                    </p>
                    <ul>
                      <li>Encryption</li>
                    ...
                    <p>
                    Using Go makes it easy to perform multiple tasks simultaneously, improving efficiency.
                    The API server has its own address api.example.com and displays a webpage with helpful information and a blueprint (schema) for developers to integrate CipherCrypt's features into their own projects.
                    This setup provides a secure and accessible foundation for developers to build upon, or to experiment with.
                    </p>
                    <h3>Caching Server Instance</h3>
                    <p>
                      CipherCrypt was designed to work with Redis, a data storage system, as a Caching solution. However, recently there have been some controversies around Redis and its place in the Open Source community.
                      As a result, the production version will switch to an alternative solution that works similarly to Redis, such as Valkey or Redict.
                      The Caching Server plays a key role in:
                    </p>
                    <ul>
                    ...
                    <p>
                      Additionally, users have the option to enable increased caching, which lets the Caching server instance handle more data.
                      This can speed up the data transfer, but can also increase the application's workload (can give negative performance if many people are using the application).
                    </p>
                    <h3>Database Connection</h3>
                    <p>
                      Note: A database is like a digital filing cabinet where information is stored and organized. It allows programs like CipherCrypt to access and manage data efficiently.
                      CipherCrypt needs a database to store its information. The database connection is like a bridge between the API server and the database.
                      To set up CipherCrypt, you need to connect it to a database. This can be:
                    </p>
                    <ul>
                    ...
                    <p>
                      Think of it like connecting to a cloud storage service, but instead of storing files, you're storing data.
                      It's important to set up the connection securely to protect your data.
                    </p>
                    <p>
                      The database stores all of CipherCrypt's information. Be careful when tinkering/experimenting with it to avoid losing or damaging data.
